...
const tiers = [
    {
        ...
        price: { monthly: '$15', annually: '$2,999' },
        mainFeatures: ['2-day conference and exhibition access', 'Access to tea, coffee, and lunch stations', 'Day 1 event evening drinks and networking'],
    },
    {
        name: 'Business',
        id: 'tier-Business',
        ...
        price: { monthly: '$60', annually: '$3,499' },
        mainFeatures: [
            'Access to event networking app (connect, schedule meetings, personalize your agenda)',
            'Access to slides and audio to ensure you can recap on key insights shared',
    ...
    },
    {
        ...
        price: { monthly: '$30', annually: '$3,999' },
        mainFeatures: ['Access to invite only VIP roundtables',
            'Easy to use accounting',
            'Insight-driven post-event report: Access a full recap on the event, key learnings, and takeaways in one sophisticated report',
            'Access our exclusive VIP zone to chill, charge, and network',
            'Reserve front row seating to be at the heart'
        ],
    },
]
const sections = [
    {
        ...
        features: [
            { name: 'Tax Savings', tiers: { Basic: true, Business: true, VIP: true } },
            { name: 'Easy to use accounting', tiers: { Basic: true, Business: true, VIP: true } },
            { name: 'Multi-accounts', tiers: { Basic: '3 accounts', Business: 'Unlimited accounts', VIP: '7 accounts' } },
            { name: 'Invoicing', tiers: { Basic: '3 invoices', Business: 'Unlimited invoices', VIP: '10 invoices' } },
            { name: 'Exclusive offers', tiers: { Basic: false, Business: true, VIP: true } },
            { name: '6 months free advisor', tiers: { Basic: false, Business: true, VIP: true } },
            { name: 'Mobile and web access', tiers: { Basic: false, Business: true, VIP: false } },
        ],
    },
    {
        name: 'Other perks',
        features: [
            { name: '24/7 customer support', tiers: { Basic: true, Business: true, VIP: true } },
            { name: 'Instant notifications', tiers: { Basic: true, Business: true, VIP: true } },
            { name: 'Budgeting tools', tiers: { Basic: true, Business: true, VIP: true } },
            { name: 'Digital receipts', tiers: { Basic: true, Business: true, VIP: true } },
            { name: 'Pots to separate money', tiers: { Basic: false, Business: true, VIP: true } },
            { name: 'Free bank transfers', tiers: { Basic: false, Business: true, VIP: false } },
            { name: 'Business debit card', tiers: { Basic: false, Business: true, VIP: false } },
        ],
    },
]
                                    ...
                                    <div className="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between lg:flex-col lg:items-stretch">
                                        <div className="mt-2 flex items-center gap-x-4">
                                            ...
                                            <div className="text-sm leading-5">
                                                <p className={tier.featured ? 'text-gray-900' : 'text-white'}>+ VAT</p>
                                                <p
